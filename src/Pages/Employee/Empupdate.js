...
const Empupdate = () => {
  ...
  const { id, EmployeeFirstName } = useParams("");

  //   const { EmployeeCode } = useParams("");
  //   const EmployeeFirstName = useParams("");

  console.log(id, EmployeeFirstName);

  const getdata = async () => {
    const res = await fetch(`http://localhost:5000/employee/getid/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
                ...
                <form onSubmit={updateuser}>
                  ...
                  <div class="mb-3">
                    <label class="small mb-1" for="inputEmailAddress">
                      Email Address: {getuserdata.EmployeeEmail}
                    </label>
                    <input
                      type="email"
                      required
                  ...
                  <div class="row gx-3 mb-3">
                    ...
                    <div class="col-md-6">
                      <label class="small mb-1" for="inputFirstName">
                        First name: {getuserdata.EmployeeFirstName}
                      </label>
                      <input
                        type="text"
                        required
